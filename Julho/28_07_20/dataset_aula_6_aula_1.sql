...
INSERT INTO cervejarias
  ("id", "name", "city", "state")
VALUES
  ('0', 'NorthGate Brewing', 'Minneapolis', 'MN'),
  ('1', 'Against the Grain Brewery', 'Louisville', 'KY'),
  ('2', 'Jacks Abby Craft Lagers', 'Framingham', 'MA'),
  ...
  ('14', 'Witchs Hat Brewing Company', 'South Lyon', 'MI'),
  ...
  ('39', 'Gonzos BiggDogg Brewing', 'Kalamazoo', 'MI'),
  ...
  ('92', 'Jackie Os Pub & Brewery', 'Athens', 'OH'),
  ...
  ('109', '"Woodstock Inn', 'Station & Brewery"', 'North Woodstock'),
  ...
  ('135', 'Pug Ryans Brewery', 'Dillon', 'CO'),
  ...
  ('170', 'Everybodys Brewing', 'White Salmon', 'WA'),
  ...
  ('188', 'Mothers Brewing', 'Springfield', 'MO'),
  ...
  ('204', 'Hawaii Nui Brewing Co.', 'Hilo', 'HI'),
  ('205', 'Peoples Brewing Company', 'Lafayette', 'IN'),
  ...
  ('224', 'Fat Heads Brewery', 'Middleburg Heights', 'OH'),
  ...
  ('237', 'Devils Backbone Brewing Company', 'Lexington', 'VA'),
  ...
  ('262', 'The Brewers Art', 'Baltimore', 'MD'),
  ...
  ('273', 'Three Notchd Brewing Company', 'Charlottesville', 'VA'),
  ...
  ('319', 'Dicks Brewing Company', 'Centralia', 'WA'),
  ...
  ('333', 'Davids Ale Works', 'Diamond Springs', 'CA'),
  ...
  ('338', 'Uncle Johns Fruit House Winery', 'St. Johns', 'MI'),
  ...
  ('388', 'Alltechs Lexington Brewing Company', 'Lexington', 'KY'),
  ...
  ('416', 'Jacks Hard Cider (Hauser Estate...', 'Biglerville', 'PA'),
  ...
  ('442', 'OFallon Brewery', 'OFallon', 'MO'),
  ...
  ('451', 'Dad & Dudes Breweria', 'Aurora', 'CO'),
  ...
  ('470', 'Petes Brewing Company', 'San Antonio', 'TX'),
  ...
  ('491', 'Devils Canyon Brewery', 'Belmont', 'CA'),
  ...
  ('505', 'Krebs Brewing Company (Petes Pl...', 'Krebs', 'OK'),
  ...
  ('517', 'Butchers Brewing', 'Carlsbad', 'CA'),
  ...
  ('552', 'Mickey Finns Brewery', 'Libertyville', 'IL'),
  ('553', 'Covington Brewhouse', 'Covington', 'LA'),
  ('554', 'Daves Brewfarm', 'Wilson', 'WI'),
